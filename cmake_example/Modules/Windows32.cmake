...
# Toolchain for 32bit windows builds
...
if (NOT WIN32)
   ...
   set( CMAKE_CXX_FLAGS_INIT "-m32 -MT" CACHE STRING "" FORCE)
   ...
   message( "Looks like you're actually on Windows 32bit with " ${CMAKE_GENERATOR} " sure I know how to do that" )
